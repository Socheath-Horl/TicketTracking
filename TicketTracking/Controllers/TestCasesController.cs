...
namespace TicketTracking.Controllers
{
    ...
    public class TestCasesController : ControllerBase
    {
        ...
        public TestCasesController(TicketsService repository, SecurityService service)
        {
        ...
        public async Task<IActionResult> Get(string id)
        {
            try
            {
                try
                {
                    var tickets = await _repository.GetAsync(new Guid(id), TicketType.Test_Case);
                    return Ok(tickets);
                }
                catch (Exception ex)
                {
        ...
        public async Task<IActionResult> Post(Ticket ticket)
        {
            try
            {
                ...
                {
                    ticket.TicketType = TicketType.Test_Case;
        ...
        public async Task<IActionResult> Put(string id, Ticket ticket)
        {
            try
            {
                var bug = await _repository.GetAsync(new Guid(id), TicketType.Test_Case);
                if (bug == null)
                {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    bug.TicketType = TicketType.Test_Case;
